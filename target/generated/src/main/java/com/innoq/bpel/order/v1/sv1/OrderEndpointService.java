 ...
 * 2012-02-15T00:26:32.030+01:00
 * Generated source version: 2.3.9
 * 
 */
@WebServiceClient(name = "OrderEndpointService", 
                  wsdlLocation = "file:/Users/martinh/DEV/CAMELSTUFF/workspaces/camelws/bpelcam/src/main/resources/wsdl/orderV1_1.wsdl",
                  targetNamespace = "http://bpel.innoq.com/order/v1/sv1") 
public class OrderEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://bpel.innoq.com/order/v1/sv1", "OrderEndpointService");
    public final static QName OrderService = new QName("http://bpel.innoq.com/order/v1/sv1", "OrderService");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/martinh/DEV/CAMELSTUFF/workspaces/camelws/bpelcam/src/main/resources/wsdl/orderV1_1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/martinh/DEV/CAMELSTUFF/workspaces/camelws/bpelcam/src/main/resources/wsdl/orderV1_1.wsdl");
        }
        WSDL_LOCATION = url;
    }
